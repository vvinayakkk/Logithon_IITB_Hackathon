...
const ItemTab = () => {
  ...
  const searchItemRestrictions = async () => {
    ...
    try {
      const response = await fetch(`http://192.168.112.55:5000/api/search-item?query=${encodeURIComponent(itemName)}&top_k=100`);
  ...
  const downloadPdf = async () => {
    ...
    //   const port = "5000"; // Replace with your actual backend port
      ...
      const result = await FileSystem.downloadAsync(
        `http://192.168.112.55:5000/generate-pdf?data=${searchData}`,
